  ...
  module.exports = (data, option) => {
  	const arrayColor = ['blue', 'yellow', 'green', 'red', 'magenta', 'yellowBright', 'blueBright', 'magentaBright','cyan']
  ...
  module.exports.loader = (data, option) => {
  	...
  	switch (option) {
  		case "warn":
  			console.log(chalk.bold.hex("#FF0000")('[ Magus ] ') + data);
  			break;
  		case "error":
  			console.log(chalk.bold.hex("#FF0000")('[ Magus ] ') + data);
  			break;
  		default:
  			console.log(color_one(`[ Magus ] `) + color_two(data));
  			break;
  	}
  }
  module.exports.banner = (data) => {
  	const rdcl = ['blue', 'yellow', 'green', 'red', 'magenta', 'yellowBright', 'blueBright', 'magentaBright','cyan']
